...
\usepackage{subfiles} % handle multi-file projects 

\usepackage{gensymb} % Generic symbols for both text and math mode

\usepackage{float} % add Float option for the images H
...
\addbibresource{articulos.bib}
\addbibresource{scilivresbib.bib}
\addbibresource{revisar.bib}
...
%----------------------------------------------------------------------------------------
%	Para hacer graficas con colores
%----------------------------------------------------------------------------------------
% Combo 1
